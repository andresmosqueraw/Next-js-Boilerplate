  ...
  return (
    <div className="relative min-h-screen w-full bg-black">
      ...
      >
        ...
        <div className="pointer-events-none hidden flex-1 flex-row items-center justify-start space-x-2 text-sm font-medium text-muted-foreground transition duration-200 hover:text-foreground md:ml-8 md:flex md:space-x-2">
          <button
            type="button"
