  ...
  return (
    <>
      <section className="relative flex min-h-screen flex-col overflow-hidden">
        <div className="relative z-10 container mx-auto flex flex-1 flex-col px-4 py-24 sm:py-32">
          ...
          >
            <div className="text-center">
              ...
              <div className="flex items-center justify-center gap-8">
                ...
                {/* Tailwind CSS Logo */}
                <div className="opacity-60 grayscale transition-all duration-300 hover:opacity-100 hover:drop-shadow-[0_0_8px_rgba(56,189,248,0.5)] hover:grayscale-0">
                  <img
