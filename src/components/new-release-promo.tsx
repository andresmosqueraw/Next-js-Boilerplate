        ...
        <div className="relative mx-auto h-[400px] max-w-4xl overflow-hidden rounded-[38px] border border-black/5 bg-primary p-2 shadow-sm dark:border-white/20">
          ...
          <div className="relative z-10">
            <div className="mt-8 text-center">
              <h2 className="mb-6 text-4xl font-bold text-white">Build. Customize. Deploy Quickly.</h2>
              <p className="mb-8 text-white/60">Built to keep you hooked.</p>
              <svg
                width="100"
                height="50"
                viewBox="0 0 100 50"
                ...
                className="mx-auto mb-4 fill-black dark:fill-white"
              >
            ...
            <h1
              className="pointer-events-none absolute inset-x-0 mt-[120px] text-center text-[100px] font-semibold text-transparent sm:mt-[30px] sm:text-[190px]"
              style={{
            ...
            <h1
              className="pointer-events-none absolute inset-x-0 mt-[120px] text-center text-[100px] font-semibold text-primary sm:mt-[30px] sm:text-[190px]"
              aria-hidden="true"
            >
              skiper/ui
            </h1>
